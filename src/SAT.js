				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Ativar_SAT_1.ativarSAT(_numeroSessao, _subComando, this._codigoAtivacao, _CNPJ, _cUF)
			...
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							_a.trys.push([0, 2, , 3]);
							_modelComunicarCertificadoICPBRASIL_1 =
								new Comunicar_Certificado_ICPBRASIL_2.ModelComunicarCertificadoICPBRASIL();
							return [
								4 /*yield*/,
								Comunicar_Certificado_ICPBRASIL_1.comunicarCertificadoICPBRASIL(
									_numeroSessao,
									this._codigoAtivacao,
									_certificado
								)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Enviar_Dados_Venda_1.enviarDadosVenda(_numeroSessao, this._codigoAtivacao, _baseCFe)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Cancela_Ultima_Venda_1.cancelarUltimaVenda(
									_numeroSessao,
									this._codigoAtivacao,
									_chave,
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Consultar_SAT_1.consultarSAT(_numeroSessao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Teste_Fim_Fim_1.testeFimFim(_numeroSessao, this._codigoAtivacao, _baseCFe)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Consultar_Status_Operacional_1.consultarStatusOperacional(_numeroSessao, this._codigoAtivacao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Consultar_Numero_Sessao_1.consultarNumeroSessao(_numeroSessao, this._codigoAtivacao, _cNumeroSessao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Configurar_Interface_Rede_1.configurarInterfaceRede(_numeroSessao, this._codigoAtivacao, _dadosConfiguracao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Associar_Assinatura_1.associarAssinatura(_numeroSessao, this._codigoAtivacao, _CNPJvalue, _assinaturaCNPJs)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Atualizar_Software_SAT_1.atualizarSoftwareSAT(_numeroSessao, this._codigoAtivacao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Extrair_Logs_1.extrairLogs(_numeroSessao, this._codigoAtivacao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Bloquear_SAT_1.bloquearSAT(_numeroSessao, this._codigoAtivacao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Desbloquear_SAT_1.desbloquearSAT(_numeroSessao, this._codigoAtivacao)
									.then(function (result) {
				...
				return __generator(this, function (_a) {
					switch (_a.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								Trocar_Codigo_Ativacao_1.trocarCodigoDeAtivacao(
									_numeroSessao,
									this._codigoAtivacao,
									_opcao,
									_novoCodigo,
