...
var ModelConsultarStatusOperacional = /** @class */ (function () {
	function ModelConsultarStatusOperacional(numeroSessao, EEEEE, mensagem, cod, mensagemSEFAZ, conteudoRetorno) {
		...
		if (mensagemSEFAZ === void 0) {
			mensagemSEFAZ = '';
		}
		if (conteudoRetorno === void 0) {
			conteudoRetorno = new ConteudoRetorno();
		}
...
var ConteudoRetorno = /** @class */ (function () {
	function ConteudoRetorno(
		...
		if (STATUS_LAN === void 0) {
			STATUS_LAN = '';
		}
		if (NIVEL_BATERIA === void 0) {
			NIVEL_BATERIA = '';
		}
		if (MT_TOTAL === void 0) {
			MT_TOTAL = '';
		...
		if (VER_LAYOUT === void 0) {
			VER_LAYOUT = '';
		}
		if (ULTIMO_CFE_SAT === void 0) {
			ULTIMO_CFE_SAT = '';
		}
		if (LISTA_INICIAL === void 0) {
			LISTA_INICIAL = '';
		}
		if (LISTA_FINAL === void 0) {
			LISTA_FINAL = '';
		}
		if (DH_CFe === void 0) {
			DH_CFe = '';
		...
		if (CERT_EMISSAO === void 0) {
			CERT_EMISSAO = '';
		}
		if (CERT_VENCIMENTO === void 0) {
			CERT_VENCIMENTO = '';
		}
		if (ESTADO_OPERACAO === void 0) {
			ESTADO_OPERACAO = '';
		}
		this.fromArray = function (_value) {
			if (_value === void 0) {
