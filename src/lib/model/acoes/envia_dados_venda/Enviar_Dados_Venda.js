...
var ModelEnviarDadosVenda = /** @class */ (function () {
	function ModelEnviarDadosVenda(
		numeroSessao,
		EEEEE,
		CCCC,
		mensagem,
		...
		if (arquivoCfeBase64 === void 0) {
			arquivoCfeBase64 = '';
		}
		if (timeStamp === void 0) {
			timeStamp = '';
		}
		if (chaveConsulta === void 0) {
			chaveConsulta = '';
		}
		if (valorTotalCFe === void 0) {
			valorTotalCFe = '';
		}
		if (CPFCNPJValue === void 0) {
			CPFCNPJValue = '';
		}
		if (assinaturaQRCODE === void 0) {
			assinaturaQRCODE = '';
		}
		if (XMLRetorno === void 0) {
			XMLRetorno = '';
		}
